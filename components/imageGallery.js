...
const description = ["image 1", "picture 2", "foto 3", "pic 4", "imagen 5"]
    ...
    return (
        <div className="">
            <a href="google.com">
                ...
                <div className=" h-max-12 text-center relative -top-8 opacity-0 hover:opacity-100 z-10 text-lg text-white font-semibold">{description[currentIndex]}</div>
            </a>
        </div>
    )
}
